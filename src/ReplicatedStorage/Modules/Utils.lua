...
local Utils = {} do
	...
	function Utils:TweenCam(camPart, cframe)
		...
		TweenService:Create(workspace.CurrentCamera, TweenInfo.new(1, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {FieldOfView = 30}):Play()
		local cf
	...
	--Gui
	function Utils:PerSecond(u56, Label)
		local u1 = {
			Stats = {
